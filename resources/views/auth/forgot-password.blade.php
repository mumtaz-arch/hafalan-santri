...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-green-50 to-green-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
        ...
        <div class="text-center">
            ...
            <p class="text-lg font-semibold text-islamic-green mt-1">Lupa Kata Sandi?</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <form method="POST" action="{{ route('password.email') }}" class="space-y-6">
                ...
                <div>
                    ...
                    <label for="email" class="block text-sm font-medium text-gray-700 mb-5">
                    ...
                    <input
                        ...
                        placeholder="Masukkan email untuk mereset password"
                        value="{{ old('email') }}"
                    >
                </div>
                ...
                <!-- Login Link -->
                <div class="text-center">
                    <span class="text-sm text-gray-600">Sudah ingat kata sandi?</span>
