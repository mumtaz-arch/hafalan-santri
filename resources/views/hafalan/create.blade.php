...
<div class="max-w-7xl mx-auto sm:px-6 lg:px-8 px-4">
        ...
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">
                    <i class="fas fa-plus-circle text-islamic-green mr-3"></i>
                    Tambah Surah Baru
                </h1>
                <p class="text-gray-600 mt-2">Tambahkan surah Al-Qur'an baru ke sistem hafalan</p>
            </div>
    ...
    <div class="bg-white rounded-lg shadow">
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('hafalan.store') }}" class="space-y-6">
                @csrf
